package com.amansaxena.nyt.ui.base
...
import com.amansaxena.nyt.di.component.DaggerFragmentComponent
import com.amansaxena.nyt.di.component.FragmentComponent
...
abstract class BaseFragment<VM : BaseViewModel> : Fragment() {
    ...
    private fun buildFragmentComponent() =
        DaggerFragmentComponent
            .builder()
            .applicationComponent((requireContext().applicationContext as MainApplication).applicationComponent)
